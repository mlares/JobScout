...
- **Ollie, all five capabilities.** Trace investigation, source-code
  ...
  (`../../integrations/job-scout/docs/ollie.md`) plus traces and a gate good enough to answer real
  questions.
...
[`../../integrations/job-scout/docs/phase3_findings.md`](../../integrations/job-scout/docs/phase3_findings.md) with the full
...
5. **A finding is not a fix.** The 15-second JSearch timeout is documented and
   ...
   `../../integrations/job-scout/docs/optimizing_latency.md`.
...
Then follow [`../../integrations/job-scout/docs/ollie.md`](../../integrations/job-scout/docs/ollie.md) in the Opik UI — the
...
Start Jupyter from the repository root so all fixture and documentation paths
resolve consistently.

## Learning materials

- [Opik tracing concepts](https://www.comet.com/docs/opik/tracing/log_traces)
- [`../../integrations/job-scout/docs/optimizing_latency.md`](../../integrations/job-scout/docs/optimizing_latency.md) — the

...
JobSourceName = Literal["jsearch", "adzuna", "himalayas", "jobicy", "remotive", "cache"]
LocationEligibility = Literal["eligible", "ineligible", "unknown"]
...
class JobPosting(BaseModel):
    ...
    location_eligibility_reason: str = "Eligibility for an Argentina-based candidate was not stated."

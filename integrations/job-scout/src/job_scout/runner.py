...
def stream_search(
    ...
    *,
    ...
    inputs = {
        ...
        "search_limit": max_jobs or settings.scout_max_jobs,
        # Every click is a fresh search, even when it reuses the session thread.
        # Otherwise changing roles would merge and preserve scores from the
        # previous role because the checkpointer retains graph state.
        "search_query": None,
        "jobs": [],
        "ranked_jobs": [],
